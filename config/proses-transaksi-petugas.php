...
if (isset($_POST['hapus'])) {
    ...
    header('Location: ../pages/petugas/penjualan.php?pesan=hapus');
    exit;
}
...
if (isset($_POST['simpan'])) {
    ...
    foreach ($_SESSION['keranjang'] as $item) {
        ...
        $queryDetail = "INSERT INTO DetailPenjualan (PenjualanID, TanggalPenjualan, NamaProduk, TotalHarga) VALUES ('$penjualanId', '$tanggalPenjualan', '$namaProduk', '$subtotal')";
    ...
    unset($_SESSION['keranjang']);
    header('Location: ../pages/petugas/penjualan.php?pesan=simpan');
    exit;
}
?>
