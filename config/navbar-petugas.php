...
<nav class="navbar navbar-expand-lg " style="background-color: #e3f2fd;">
  ...
  <a class="navbar-brand" href="#">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active bi-cart-fill" aria-current="page" href="../../pages/petugas/penjualan.php"> Penjualan</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active bi-receipt-cutoff" aria-current="page" href="../../pages/petugas/data-barang.php"> Data Barang</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active bi bi-clipboard-data-fill" aria-current="page" href="../../pages/petugas/data-penjualan.php"> Data Penjualan</a>
        </li>
        <li class="nav-item">
